...
The template processing might be aborted by an exception thrown by
embedded Perl codes.  An error handler has to be installed by
C<onerror> method to detect whether the template processing has been
